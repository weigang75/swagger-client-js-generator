    ...
    function Wb(a, b, c, d) { var e, f, g, h, i, j = {},
        ...
        f = k.shift(); while (f)
            ...
            function y(b, c, d, e) { var k, s, t, v, x, y = c;
                2 !== u && (u = 2, h && a.clearTimeout(h), j = void 0, g = e || "", w.readyState = b > 0 ? 4 : 0, k = b >= 200 && 300 > b || 304 === b, d && (v = Vb(l, w, d)), v = Wb(l, v, w, k), k ? (l.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (n.lastModified[f] = x), x = w.getResponseHeader("etag"), x && (n.etag[f] = x)), 204 === b || "HEAD" === l.type ? y = "nocontent" : 304 === b ? y = "notmodified" : (y = v.state, s = v.data, t = v.error, k = !t)) : (t = y, (b || !y) && (y = "error", 0 > b && (b = 0))), w.status = b, w.statusText = (c || y) + "", k ? p.resolveWith(m, [s, y, w]) : p.rejectWith(m, [w, y, t]), w.statusCode(r), r = void 0, i && o.trigger(k ? "ajaxSuccess" : "ajaxError", [w, l, k ? s : t]), q.fireWith(m, [w, y]), i && (o.trigger("ajaxComplete", [w, l]), --n.active || n.event.trigger("ajaxStop"))) } return w }, getJSON: function(a, b, c) { return n.get(a, b, c, "json") }, getScript: function(a, b) { return n.get(a, void 0, b, "script") } }), n.each(["get", "post","put","del"], function(a, b) { n[b] = function(a, c, d, e) { if(b=="del"){b="delete"};return n.isFunction(c) && (e = e || d, d = c, c = void 0), n.ajax(n.extend({ url: a, type: b, dataType: e, data: c, success: d ,contentType: b.toLowerCase() == 'get'?'application/x-www-form-urlencoded;charset=utf-8':'application/json;charset=utf-8'}, n.isPlainObject(a) && a)) } }), n._evalUrl = function(a) { return n.ajax({ url: a, type: "GET", dataType: "script", cache: !0, async: !1, global: !1, "throws": !0 }) }, n.fn.extend({ wrapAll: function(a) { if (n.isFunction(a)) return this.each(function(b) { n(this).wrapAll(a.call(this, b)) }); if (this[0]) { var b = n(a, this[0].ownerDocument).eq(0).clone(!0);
...
/*! FormAjax */
(function(b) { "function" === typeof define && define.amd ? define(["jquery"], b) : b("undefined" != typeof jQuery ? jQuery : window.Zepto) })(function(b) {
    function u(a) { var d = a.data;
        a.isDefaultPrevented() || (a.preventDefault(), b(a.target).ajaxSubmit(d)) }

    function z(a) { var d = a.target,
            c = b(d); if (!c.is("[type=submit],[type=image]")) { d = c.closest("[type=submit]"); if (0 === d.length) return;
            d = d[0] } var f = this;
        f.clk = d; "image" == d.type && (void 0 !== a.offsetX ? (f.clk_x = a.offsetX, f.clk_y = a.offsetY) : "function" == typeof b.fn.offset ? (c = c.offset(), f.clk_x = a.pageX - c.left, f.clk_y = a.pageY - c.top) : (f.clk_x = a.pageX - d.offsetLeft, f.clk_y = a.pageY - d.offsetTop));
        setTimeout(function() { f.clk = f.clk_x = f.clk_y = null }, 100) }

    function r() { if (b.fn.ajaxSubmit.debug) { var a = "[jquery.form] " + Array.prototype.join.call(arguments, "");
            window.console && window.console.log ? window.console.log(a) : window.opera && window.opera.postError && window.opera.postError(a) } } var A, D;
    A = void 0 !== b("<input type='file'/>").get(0).files;
    D = void 0 !== window.FormData; var I = !!b.fn.prop;
    b.fn.attr2 = function() { if (!I) return this.attr.apply(this, arguments); var a = this.prop.apply(this, arguments); return a && a.jquery || "string" === typeof a ? a : this.attr.apply(this, arguments) };
    b.fn.ajaxSubmit = function(a) {
        function d(d) { d = b.param(d, a.traditional).split("&"); var f = d.length,
                h = [],
                g, c; for (g = 0; g < f; g++) d[g] = d[g].replace(/\+/g, " "), c = d[g].split("="), h.push([decodeURIComponent(c[0]), decodeURIComponent(c[1])]); return h }

        function c(f) { for (var g = new FormData, c = 0; c < f.length; c++) g.append(f[c].name, f[c].value); if (a.extraData)
                for (f = d(a.extraData), c = 0; c < f.length; c++) f[c] && g.append(f[c][0], f[c][1]);
            a.data = null;
            c = b.extend(!0, {}, b.ajaxSettings, a, { contentType: !1, processData: !1, cache: !1, type: h || "POST" });
            a.uploadProgress && (c.xhr = function() { var c = b.ajaxSettings.xhr();
                c.upload && c.upload.addEventListener("progress", function(b) { var e = 0,
                        c = b.loaded || b.position,
                        f = b.total;
                    b.lengthComputable && (e = Math.ceil(c / f * 100));
                    a.uploadProgress(b, c, f, e) }, !1); return c });
            c.data = null; var l = c.beforeSend;
            c.beforeSend = function(b, c) { c.data = a.formData ? a.formData : g;
                l && l.call(this, b, c) }; return b.ajax(c) }

        function f(c) {
            function f(a) { var b = null; try { a.contentWindow && (b = a.contentWindow.document) } catch (F) { r("cannot get iframe.contentWindow document: " + F) } if (b) return b; try { b = a.contentDocument ? a.contentDocument : a.document } catch (F) { r("cannot get iframe.contentDocument: " + F), b = a.document } return b }

            function d() {
                function a() { try { var b = f(v).readyState;
                        r("state = " + b);
                        b && "uninitialized" == b.toLowerCase() && setTimeout(a, 50) } catch (J) { r("Server abort: ", J, " (", J.name, ")"), g(2), u && clearTimeout(u), u = void 0 } } var c = n.attr2("target"),
                    d = n.attr2("action"),
                    k = n.attr("enctype") || n.attr("encoding") || "multipart/form-data";
                l.setAttribute("target", C);
                h && !/post/i.test(h) || l.setAttribute("method", "POST");
                d != e.url && l.setAttribute("action", e.url);
                e.skipEncodingOverride || h && !/post/i.test(h) || n.attr({ encoding: "multipart/form-data", enctype: "multipart/form-data" });
                e.timeout && (u = setTimeout(function() { y = !0;
                    g(1) }, e.timeout)); var m = []; try { if (e.extraData)
                        for (var p in e.extraData) e.extraData.hasOwnProperty(p) && (b.isPlainObject(e.extraData[p]) && e.extraData[p].hasOwnProperty("name") && e.extraData[p].hasOwnProperty("value") ? m.push(b('<input type="hidden" name="' + e.extraData[p].name + '">').val(e.extraData[p].value).appendTo(l)[0]) : m.push(b('<input type="hidden" name="' + p + '">').val(e.extraData[p]).appendTo(l)[0]));
                    e.iframeTarget || w.appendTo("body");
                    v.attachEvent ? v.attachEvent("onload", g) : v.addEventListener("load", g, !1);
                    setTimeout(a, 15); try { l.submit() } catch (L) { document.createElement("form").submit.apply(l) } } finally { l.setAttribute("action", d), l.setAttribute("enctype", k), c ? l.setAttribute("target", c) : n.removeAttr("target"), b(m).remove() } }

            function g(a) { if (!k.aborted && !A)
                    if (p = f(v), p || (r("cannot access response document"), a = 2), 1 === a && k) k.abort("timeout"), x.reject(k, "timeout");
                    else if (2 == a && k) k.abort("server abort"), x.reject(k, "error", "server abort");
                else if (p && p.location.href != e.iframeSrc || y) { v.detachEvent ? v.detachEvent("onload", g) : v.removeEventListener("load", g, !1);
                    a = "success"; var c; try { if (y) throw "timeout"; var d = "xml" == e.dataType || p.XMLDocument || b.isXMLDoc(p);
                        r("isXml=" + d); if (!d && window.opera && (null === p.body || !p.body.innerHTML) && --B) { r("requeing onLoad callback, DOM not available");
                            setTimeout(g, 250); return } var h = p.body ? p.body : p.documentElement;
                        k.responseText = h ? h.innerHTML : null;
                        k.responseXML = p.XMLDocument ? p.XMLDocument : p;
                        d && (e.dataType = "xml");
                        k.getResponseHeader = function(a) { return { "content-type": e.dataType }[a.toLowerCase()] };
                        h && (k.status = Number(h.getAttribute("status")) || k.status, k.statusText = h.getAttribute("statusText") || k.statusText); var l = (e.dataType || "").toLowerCase(),
                            m = /(json|script|text)/.test(l); if (m || e.textarea) { var n = p.getElementsByTagName("textarea")[0]; if (n) k.responseText = n.value, k.status = Number(n.getAttribute("status")) || k.status, k.statusText = n.getAttribute("statusText") || k.statusText;
                            else if (m) { var E = p.getElementsByTagName("pre")[0],
                                    q = p.getElementsByTagName("body")[0];
                                E ? k.responseText = E.textContent ? E.textContent : E.innerText : q && (k.responseText = q.textContent ? q.textContent : q.innerText) } } else "xml" == l && !k.responseXML && k.responseText && (k.responseXML = D(k.responseText)); try { z = K(k, l, e) } catch (G) { a = "parsererror", k.error = c = G || a } } catch (G) { r("error caught: ", G), a = "error", k.error = c = G || a } k.aborted && (r("upload aborted"), a = null);
                    k.status && (a = 200 <= k.status && 300 > k.status || 304 === k.status ? "success" : "error"); "success" === a ? (e.success && e.success.call(e.context, z, "success", k), x.resolve(k.responseText, "success", k), t && b.event.trigger("ajaxSuccess", [k, e])) : a && (void 0 === c && (c = k.statusText), e.error && e.error.call(e.context, k, a, c), x.reject(k, "error", c), t && b.event.trigger("ajaxError", [k, e, c]));
                    ...
                    setTimeout(function() { e.iframeTarget ? w.attr("src", e.iframeSrc) : w.remove();
                        k.responseXML = null }, 100) } } var l = n[0],
                m, e, t, C, w, v, k, y, u, x = b.Deferred();
            x.abort = function(a) { k.abort(a) }; if (c)
                for (m = 0; m < q.length; m++) c = b(q[m]), I ? c.prop("disabled", !1) : c.removeAttr("disabled");
            e = b.extend(!0, {}, b.ajaxSettings, a);
            e.context = e.context || e;
            C = "jqFormIO" + (new Date).getTime();
            e.iframeTarget ? (w = b(e.iframeTarget), (m = w.attr2("name")) ? C = m : w.attr2("name", C)) : (w = b('<iframe name="' + C + '" src="' + e.iframeSrc + '" />'), w.css({ position: "absolute", top: "-1000px", left: "-1000px" }));
            v = w[0];
            k = { aborted: 0, responseText: null, responseXML: null, status: 0, statusText: "n/a", getAllResponseHeaders: function() {}, getResponseHeader: function() {}, setRequestHeader: function() {}, abort: function(a) { var c = "timeout" === a ? "timeout" : "aborted";
                    r("aborting upload... " + c);
                    this.aborted = 1; try { v.contentWindow.document.execCommand && v.contentWindow.document.execCommand("Stop") } catch (F) {} w.attr("src", e.iframeSrc);
                    k.error = c;
            ...
            t && b.event.trigger("ajaxSend", [k, e]); if (e.beforeSend && !1 === e.beforeSend.call(e.context, k, e)) return e.global && b.active--, x.reject(), x; if (k.aborted) return x.reject(), x;
            (c = l.clk) && (m = c.name) && !c.disabled && (e.extraData = e.extraData || {}, e.extraData[m] = c.value, "image" == c.type && (e.extraData[m + ".x"] = l.clk_x, e.extraData[m + ".y"] = l.clk_y));
            c = b("meta[name=csrf-token]").attr("content");
            (m = b("meta[name=csrf-param]").attr("content")) && c && (e.extraData = e.extraData || {}, e.extraData[m] = c);
            e.forceSync ? d() : setTimeout(d, 10); var z, p, B = 50,
                A, D = b.parseXML || function(a, b) { window.ActiveXObject ? (b = new ActiveXObject("Microsoft.XMLDOM"), b.async = "false", b.loadXML(a)) : b = (new DOMParser).parseFromString(a, "text/xml"); return b && b.documentElement && "parsererror" != b.documentElement.nodeName ? b : null },
                H = b.parseJSON || function(a) { return window.eval("(" + a + ")") },
                K = function(a, c, e) { var d = a.getResponseHeader("content-type") || "",
                        f = "xml" === c || !c && 0 <= d.indexOf("xml");
                    a = f ? a.responseXML : a.responseText;
                    f && "parsererror" === a.documentElement.nodeName && b.error && b.error("parsererror");
                    e && e.dataFilter && (a = e.dataFilter(a, c)); "string" === typeof a && ("json" === c || !c && 0 <= d.indexOf("json") ? a = H(a) : ("script" === c || !c && 0 <= d.indexOf("javascript")) && b.globalEval(a)); return a }; return x } if (!this.length) return r("ajaxSubmit: skipping submit process - no element selected"), this; var h, g, n = this; "function" == typeof a ? a = { success: a } : void 0 === a && (a = {});
        h = a.type || this.attr2("method");
        g = a.url || this.attr2("action");
        (g = (g = "string" === typeof g ? b.trim(g) : "") || window.location.href || "") && (g = (g.match(/^([^#]+)/) || [])[1]);
        a = b.extend(!0, { url: g, success: b.ajaxSettings.success, type: h || b.ajaxSettings.type, iframeSrc: /^https/i.test(window.location.href || "") ? "javascript:false" : "about:blank" }, a);
        g = {};
        this.trigger("form-pre-serialize", [this, a, g]); if (g.veto) return r("ajaxSubmit: submit vetoed via form-pre-serialize trigger"), this; if (a.beforeSerialize && !1 === a.beforeSerialize(this, a)) return r("ajaxSubmit: submit aborted via beforeSerialize callback"), this; var m = a.traditional;
        void 0 === m && (m = b.ajaxSettings.traditional); var q = [],
            l, t = this.formToArray(a.semantic, q);
        a.data && (a.extraData = a.data, l = b.param(a.data, m)); if (a.beforeSubmit && !1 === a.beforeSubmit(t, this, a)) return r("ajaxSubmit: submit aborted via beforeSubmit callback"), this;
        this.trigger("form-submit-validate", [t, this, a, g]); if (g.veto) return r("ajaxSubmit: submit vetoed via form-submit-validate trigger"), this;
        g = b.param(t, m);
        l && (g = g ? g + "&" + l : l); "GET" == a.type.toUpperCase() ? (a.url += (0 <= a.url.indexOf("?") ? "&" : "?") + g, a.data = null) : a.data = g; var y = [];
        a.resetForm && y.push(function() { n.resetForm() });
        a.clearForm && y.push(function() { n.clearForm(a.includeHidden) }); if (!a.dataType && a.target) { var u = a.success || function() {};
            y.push(function(c) { var d = a.replaceTarget ? "replaceWith" : "html";
                b(a.target)[d](c).each(u, arguments) }) } else a.success && y.push(a.success);
        a.success = function(b, c, d) { for (var f = a.context || this, g = 0, h = y.length; g < h; g++) y[g].apply(f, [b, c, d || n, n]) }; if (a.error) { var z = a.error;
            a.error = function(b, c, d) { z.apply(a.context || this, [b, c, d, n]) } } if (a.complete) { var H = a.complete;
            a.complete = function(b, c) { H.apply(a.context || this, [b, c, n]) } } l = 0 < b("input[type=file]:enabled", this).filter(function() { return "" !== b(this).val() }).length;
        g = "multipart/form-data" == n.attr("enctype") || "multipart/form-data" == n.attr("encoding");
        m = A && D;
        r("fileAPI :" + m); var B;!1 !== a.iframe && (a.iframe || (l || g) && !m) ? a.closeKeepAlive ? b.get(a.closeKeepAlive, function() { B = f(t) }) : B = f(t) : B = (l || g) && m ? c(t) : b.ajax(a);
        n.removeData("jqxhr").data("jqxhr", B); for (l = 0; l < q.length; l++) q[l] = null;
        this.trigger("form-submit-notify", [this, a]); return this };
    b.fn.ajaxForm = function(a) { a = a || {};
        a.delegation = a.delegation && b.isFunction(b.fn.on); if (!a.delegation && 0 === this.length) { var d = this.selector,
                c = this.context; if (!b.isReady && d) return r("DOM not ready, queuing ajaxForm"), b(function() { b(d, c).ajaxForm(a) }), this;
            r("terminating; zero elements found by selector" + (b.isReady ? "" : " (DOM not ready)")); return this } return a.delegation ? (b(document).off("submit.form-plugin", this.selector, u).off("click.form-plugin", this.selector, z).on("submit.form-plugin", this.selector, a, u).on("click.form-plugin", this.selector, a, z), this) : this.ajaxFormUnbind().bind("submit.form-plugin", a, u).bind("click.form-plugin", a, z) };
    b.fn.ajaxFormUnbind = function() { return this.unbind("submit.form-plugin click.form-plugin") };
    b.fn.formToArray = function(a, d) { var c = []; if (0 === this.length) return c; var f = this[0],
            h = this.attr("id"),
            g = a ? f.getElementsByTagName("*") : f.elements;
        g && !/MSIE [678]/.test(navigator.userAgent) && (g = b(g).get());
        h && (h = b(':input[form="' + h + '"]').get(), h.length && (g = (g || []).concat(h))); if (!g || !g.length) return c; var n, m, q, l, r;
        n = 0; for (r = g.length; n < r; n++)
            if (l = g[n], (h = l.name) && !l.disabled)
                if (a && f.clk && "image" == l.type) f.clk == l && (c.push({ name: h, value: b(l).val(), type: l.type }), c.push({ name: h + ".x", value: f.clk_x }, { name: h + ".y", value: f.clk_y }));
                else if ((q = b.fieldValue(l, !0)) && q.constructor == Array)
            for (d && d.push(l), m = 0, l = q.length; m < l; m++) c.push({ name: h, value: q[m] });
        else if (A && "file" == l.type)
            if (d && d.push(l), q = l.files, q.length)
                for (m = 0; m < q.length; m++) c.push({ name: h, value: q[m], type: l.type });
            else c.push({ name: h, value: "", type: l.type });
        else null !== q && "undefined" != typeof q && (d && d.push(l), c.push({ name: h, value: q, type: l.type, required: l.required }));!a && f.clk && (a = b(f.clk), d = a[0], (h = d.name) && !d.disabled && "image" == d.type && (c.push({ name: h, value: a.val() }), c.push({ name: h + ".x", value: f.clk_x }, { name: h + ".y", value: f.clk_y }))); return c };
    b.fn.formSerialize = function(a) { return b.param(this.formToArray(a)) };
    b.fn.fieldSerialize = function(a) { var d = [];
        this.each(function() { var c = this.name; if (c) { var f = b.fieldValue(this, a); if (f && f.constructor == Array)
                    for (var h = 0, g = f.length; h < g; h++) d.push({ name: c, value: f[h] });
                else null !== f && "undefined" != typeof f && d.push({ name: this.name, value: f }) } }); return b.param(d) };
    b.fn.fieldValue = function(a) { for (var d = [], c = 0, f = this.length; c < f; c++) { var h = b.fieldValue(this[c], a);
            null === h || "undefined" == typeof h || h.constructor == Array && !h.length || (h.constructor == Array ? b.merge(d, h) : d.push(h)) } return d };
    b.fieldValue = function(a, d) { var c = a.name,
            f = a.type,
            h = a.tagName.toLowerCase();
        void 0 === d && (d = !0); if (d && (!c || a.disabled || "reset" == f || "button" == f || ("checkbox" == f || "radio" == f) && !a.checked || ("submit" == f || "image" == f) && a.form && a.form.clk != a || "select" == h && -1 == a.selectedIndex)) return null; if ("select" == h) { h = a.selectedIndex; if (0 > h) return null;
            d = [];
            a = a.options;
            c = (f = "select-one" == f) ? h + 1 : a.length; for (h = f ? h : 0; h < c; h++) { var g = a[h]; if (g.selected) { var n = g.value;
                    n || (n = g.attributes && g.attributes.value && !g.attributes.value.specified ? g.text : g.value); if (f) return n;
                    d.push(n) } } return d } return b(a).val() };
    b.fn.clearForm = function(a) { return this.each(function() { b("input,select,textarea", this).clearFields(a) }) };
    b.fn.clearFields = b.fn.clearInputs = function(a) { var d = /^(?:color|date|datetime|email|month|number|password|range|search|tel|text|time|url|week)$/i; return this.each(function() { var c = this.type,
                f = this.tagName.toLowerCase();
            d.test(c) || "textarea" == f ? this.value = "" : "checkbox" == c || "radio" == c ? this.checked = !1 : "select" == f ? this.selectedIndex = -1 : "file" == c ? /MSIE/.test(navigator.userAgent) ? b(this).replaceWith(b(this).clone(!0)) : b(this).val("") : a && (!0 === a && /hidden/.test(c) || "string" == typeof a && b(this).is(a)) && (this.value = "") }) };
    b.fn.resetForm = function() { return this.each(function() {
            ("function" == typeof this.reset || "object" == typeof this.reset && !this.reset.nodeType) && this.reset() }) };
    b.fn.enable = function(a) { void 0 === a && (a = !0); return this.each(function() { this.disabled = !a }) };
    b.fn.selected = function(a) { void 0 === a && (a = !0); return this.each(function() { var d = this.type; "checkbox" == d || "radio" == d ? this.checked = a : "option" == this.tagName.toLowerCase() && (d = b(this).parent("select"), a && d[0] && "select-one" == d[0].type && d.find("option").selected(!1), this.selected = a) }) };
    b.fn.ajaxSubmit.debug = !1 });
/*MD5*/
(function(u) { var k = function(a, c) { var h, g, k, m;
            k = a & 2147483648;
            m = c & 2147483648;
            h = a & 1073741824;
            g = c & 1073741824;
            a = (a & 1073741823) + (c & 1073741823); return h & g ? a ^ 2147483648 ^ k ^ m : h | g ? a & 1073741824 ? a ^ 3221225472 ^ k ^ m : a ^ 1073741824 ^ k ^ m : a ^ k ^ m },
        l = function(a, c, h, g, l, m, b) { a = k(a, k(k(c & h | ~c & g, l), b)); return k(a << m | a >>> 32 - m, c) },
        n = function(a, c, h, g, l, m, b) { a = k(a, k(k(c & g | h & ~g, l), b)); return k(a << m | a >>> 32 - m, c) },
        p = function(a, c, h, g, l, m, b) { a = k(a, k(k(c ^ h ^ g, l), b)); return k(a << m | a >>> 32 - m, c) },
        q = function(a, c, h, g, l, m, b) { a = k(a, k(k(h ^ (c | ~g), l), b)); return k(a << m | a >>> 32 - m, c) },
        t = function(a) { var c = "",
                h, g; for (g = 0; 3 >= g; g++) h = a >>> 8 * g & 255, h = "0" + h.toString(16), c += h.substr(h.length - 2, 2); return c };
    u.extend({ md5: function(a) { var c, h, g, r, m, b, d, e, f;
            a = a.replace(/\x0d\x0a/g, "\n");
            c = ""; for (h = 0; h < a.length; h++) g = a.charCodeAt(h), 128 > g ? c += String.fromCharCode(g) : (127 < g && 2048 > g ? c += String.fromCharCode(g >> 6 | 192) : (c += String.fromCharCode(g >> 12 | 224), c += String.fromCharCode(g >> 6 & 63 | 128)), c += String.fromCharCode(g & 63 | 128));
            h = c.length;
            a = h + 8;
            r = 16 * ((a - a % 64) / 64 + 1);
            a = Array(r - 1); for (b = 0; b < h;) g = (b - b % 4) / 4, m = b % 4 * 8, a[g] |= c.charCodeAt(b) << m, b++;
            g = (b - b % 4) / 4;
            a[g] |= 128 << b % 4 * 8;
            a[r - 2] = h << 3;
            a[r - 1] = h >>> 29;
